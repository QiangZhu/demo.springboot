 ...
 * zq
 */
package demo.springboot.security.casshiro.sample1;
 ...
 * Package : demo.springboot.security.casshiro.sample1
 * 
 * @author YixinCapital -- zq 2017年3月21日 上午9:18:33
 *
 */
@Configuration
public class ShiroCasConfiguration {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager,
			CasFilter casFilter, StudentService stuService, IScoreDao scoreDao) {
